...
//        }
//
////        ((RuuviScannerApplication)getApplication()).scannerJobBluetoothGateway.startScan();
//
...
//        NeovisionariesLeScanResult dev = new NeovisionariesLeScanResult();
//        dev.device = device;
//        dev.rssi = rssi;
//        dev.scanData = data;
//
