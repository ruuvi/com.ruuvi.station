...
class ComplexWidgetProvider: GlanceAppWidgetReceiver() {
    ...
    // Required for Glance-backed LazyColumn widgets; the receiver must expose the widget
    // instance used by Android's RemoteViewsService.
    override val glanceAppWidget: GlanceAppWidget = ComplexWidgetGlanceWidget
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == MANUAL_REFRESH) {
