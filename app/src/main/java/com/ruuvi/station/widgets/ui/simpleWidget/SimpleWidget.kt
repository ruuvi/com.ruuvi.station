...
class SimpleWidget: GlanceAppWidgetReceiver() {
    ...
    // Required so Glance wires onAppWidgetOptionsChanged into recomposition — without this,
    // the widget only reflects the host-granted size it saw at initial bind (see #1416).
